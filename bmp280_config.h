...
typedef struct {
    void* bus_user;
    bmp280_err_t (*bus_init)(void*);
    bmp280_err_t (*bus_deinit)(void*);
    bmp280_err_t (*bus_write)(void*, uint8_t, uint8_t const*, size_t);
    bmp280_err_t (*bus_read)(void*, uint8_t, uint8_t*, size_t);
} bmp280_interface_t;
